...
# Power operations
client.power_on()
client.power_off()        # Graceful shutdown
client.force_power_off()  # Force power off
client.power_restart()    # Graceful restart

# Set boot source for next reboot
client.set_boot_source("Pxe")   # PXE boot
client.set_boot_source("Hdd")   # Hard drive boot
client.set_boot_source("BiosSetup")  # Enter BIOS setup
```
